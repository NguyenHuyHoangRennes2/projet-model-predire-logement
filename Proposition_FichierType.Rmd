...
### Vérification des effectifs et cohérence interne
...
variables_quanti <- annonces %>%
  select(Loyer_TTC, Surface, Charges, Pièces, kWh, kgCO2)

summary_stats <- variables_quanti %>%
  summarise(
...
knitr::kable(summary_stats, caption = "Tableau 2 : Statistiques descriptives des variables quantitatives")
```
